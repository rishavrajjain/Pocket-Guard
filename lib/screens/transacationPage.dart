import 'package:pocket_guard/utilities/themeColors.dart';
import 'package:pocket_guard/utilities/themeStyles.dart';
import 'package:pocket_guard/widgets/addNote.dart';
import 'package:pocket_guard/widgets/cardInPage.dart';
import 'package:pocket_guard/widgets/otherDetailsDivider.dart';
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child:
                                  Text('#crypto', style: ThemeStyles.tagText)),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 4.0, right: 4.0),
                        child: Container(
                          ...
                          child: Center(
                              child:
                                  Text('#savings', style: ThemeStyles.tagText)),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 4.0, right: 4.0),
                        child: Container(
                          ...
                          child: Center(
                              child:
                                  Text('#Roth IRA', style: ThemeStyles.tagText)),
                        ),
                      ),
